...
| **자재 목록** | `embed/products.html` | 200종. 대분류탭(V/S/E/U/T)·필터(재고없음/대체품/A등급/미달/해외)·검색·정렬·CSV.<br>클릭 시 **품번체계 분해**·기본정보·재고·보유LOT·**완제품 사용처(BOM)**·안전재고.<br>**[전체 LOT 이력 조회]** 버튼 → 모달로 그 자재의 전 LOT 일생(발주→입고→불출→생산투입)과 FIFO 위반 표시 |
